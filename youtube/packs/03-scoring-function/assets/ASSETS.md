# Tutorial 03 pack assets

| File | Role |
|------|------|
| `pipeline.svg` / `pipeline.png` | Sampling → Scoring → RL diagram |
| `metrics-callout.svg` / `metrics-callout.png` | 96 mols / ~2s / Score stats |
| `score-distribution.png` | Handbook score histogram + QED–MW |
